...
public class BoilerpipeContentHandler extends BoilerpipeHTMLContentHandler {
    ...
    private static Set<String> IGNORED_ELEMENTS = new HashSet<>();
    
    static {
        IGNORED_ELEMENTS.add("script");
        IGNORED_ELEMENTS.add("style");
        IGNORED_ELEMENTS.add("link");
    }
    ...
    private Stack<String> ignoringElements;
    ...
    public BoilerpipeContentHandler(ContentHandler delegate, BoilerpipeExtractor extractor) {
        ...
        this.ignoringElements = new Stack<>();
    }
    ...
    public void characters(char[] chars, int offset, int length) throws SAXException {
        ...
        if (!ignoringElements.isEmpty()) {
            // We're ignoring text from inside of some element
        } else if (inHeader) {
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        ...
        String name = localName.toLowerCase(Locale.US);
        if (!ignoringElements.isEmpty() && ignoringElements.peek().equals(name)) {
            ignoringElements.pop();
        }
